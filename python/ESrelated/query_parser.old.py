...
class ConfigClauseParser:
    def __init__(self):
        super(ConfigClauseParser, self).__init__()
        self.clause = ""
    ...
    def process_clause(self):
        return self.get_config_clause(self.clause)
...
if "__main__" == __name__:
    parsers = {
        ...
        "config":ConfigClauseParser(),
        "agg":AggClauseParser()}
    
    print json.dumps(parsers[sys.argv[1]].parse_clause(sys.argv[2]))    
